...
<head>
	...
	<meta charset="UTF-8">
	<meta name="description" content="Flex Fitness">
	<meta name="keywords" content="Fitness, Gym, yoga, html">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2>Home</h2>
					<p>Gym and Yoga can improve your health</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="pricing-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<p>Practice Yoga to perfect physical beauty, take care of your soul and enjoy life more fully!
					<br>
					join our Gym today and get heavy discount.  
